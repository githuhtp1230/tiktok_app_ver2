...
class _Service implements Service {
  ...
  Future<ListVideoResponse> getListVideo(
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'start_index': startIndex,
      r'limit': limit,
    };
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ListVideoResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ListVideoResponse _value;
    try {
      _value = ListVideoResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<SuccessResponse> handleLikeVideo(
    int idVideo,
    ...
    final _options = _setStreamType<SuccessResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'api/videos/${idVideo}/handle-like',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<CommentListResponse> getListComment(
    int idVideo,
    int pageSize,
    int page,
  ) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CommentListResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<SuccessResponse> handleLikeComment(
    int idComment,
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    final _options = _setStreamType<SuccessResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'api/comments/${idComment}/handle-like',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
